...
python scripts/3_llm_reranker/3_2b_clean_LLM_create_opp-db.py `
  ...
  --out              "C:\Users\jasmi\OneDrive - Nexus365\Documents\PhD - Oxford BSG\Paper writing projects\Ongoing\Compass\data\pre_study\2026-03-30_opportunity_database_only_active.json" `
